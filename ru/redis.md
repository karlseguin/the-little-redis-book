...
Суть в том что Redis представляет пять разных структур данных, только одна с которых собственно и есть структурой типу ключ-значение. Понимание этих пяти структур данных, как они роботают, какие методы они представляют и что вы сможете моделиолваьть с их помощью как раз и являются ключом к пониманию Redis. Но сначала, давайте розмотрим что же всетаки значит - представление структурры данных.
 ...
 Таблицы по сути сложные и гибкие. Здесь не так уж и много вещей которые вы б не смогли смоделиолвать, сохранять или манипулировать при помощи таблиц. Тем не мение, они тоже не идеальны. А именно, не все на столько простое, или на столько быстрое, на сколько оно должно б быть. Что если в место универсальной стуктуры, мы б использували специализированные структуры? Здесь наверное найдутся вещи которые мы не сможем зделать (или по крайней мере сможем зделать не совсем хорошо), но в любом случае мы выиграем на простоте и скорости.

Использование спецефической сруктурой данных для спецефических задач? Разве это не то как мы кодим?
