...
Допустим, мы хотим отслеживать цену акций определенного тикера. (*Тикер - краткое название в биржевой информации котируемых инструментов - например, акций компаний - прим. перев.*) Тикер будет ключом, весовым коэффициентом (*score*) будет время, а значением будет цена:
