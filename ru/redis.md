...
Меня зовут Андрей Кондратович. Вы можете найти меня в [Twitter](https://twitter.com/_sparrow).

Данный перевод выполнен с целью популяризации Redis среди русскоговорящих \linebreak разработчиком. Книга является очень удобным и компактным руководством.
...
\item - \href{https://github.com/saippuakauppias}{Denis Veselov}
